...
extension DeviceSelectorViewController
{
    override func viewDidLoad(){
        ...
        //testOtaFileDownload.checkForNewFirmware()
    ...
    override func viewWillAppear(_ animated: Bool)
    {
        // New 3-14-18
        viewModel.reset()
        logDataManager.logFileManager!.createNewFileWithName(name: "SYS_LOG\(Date())")
        //Add notification observers before view appears
        //addObservers()
        connectionStatusView.isHidden = true
    ...
    {
        print("DeviceSelectorViewController: REMOVE BINDINGS")
        removeBindings()
        viewModel.close()
    }
...
extension DeviceSelectorViewController: UITableViewDelegate
{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        //bleManager.connect(toPeripheral: discoveredPeripherals[indexPath.row].peripheral, withTimeout: 5)
    }    
}
