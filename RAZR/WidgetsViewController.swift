...
extension WidgetsViewController
{
    ...
    override func viewWillDisappear(_ animated: Bool) {
        print("WidgetsViewController: viewWillDisappear")
        removeBindings()
        viewModel.close()
...
extension WidgetsViewController
{
    ...
    func removeBindings(){
        viewModel.isConnected.bind(listener: nil)
    }
}
...
extension WidgetsViewController: UICollectionViewDelegate,
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath){
        ...
        case 0: //print("One")
            ...
            //  Make sure spectrum analyzer service is valid
        ...
        case 4:
            ...
            //  Make sure ota service is valid
        ...
        case 5:
            ...
            // Make sure information service is valid
        ...
        case 7: print("Winegard Company Widget")
            ...
            //  Open the winegard website in safari
