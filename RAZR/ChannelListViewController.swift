...
class ChannelListViewController: UIViewController
{
    ...
    /******************************************************************************/
    //let CHAR_VALUE_UPDATED_HANDLER = #selector(ChannelListViewController.newValueReported(_:))
...
extension ChannelListViewController
{
    ...
    func addObservers()
    {
        //NotificationCenter.default.addObserver(self, selector: CHAR_VALUE_UPDATED_HANDLER, name: CHAR_VALUE_UPDATED, object: nil)
...
extension ChannelListViewController
{
    ...
    {
        //let char = connectedWinegardDevice.winegardGattProfile!.winegardScanConfigurationChar!
...
extension ChannelListViewController
{
    ...
    @IBAction func upDownButton(_ sender: UIButton)
    {
        ...
        let testPacket: [UInt8] = [0x03, formattedChannel]//, 0x45, 0x92, 0x80, 0x30, 0xE7, 0xD6, 0x20, 0x00, 0x1A, 0xB3, 0xF0]
...
extension ChannelListViewController: UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView,numberOfRowsInSection section: Int) -> Int{
        ...
        ///NEED TO TEST
        return count//recievedChannelDataArrayLocalCopy.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        var jumpToIndividualButton =  UIButton(frame: CGRect(x: 0, y: 20, width: 40, height: 40))
        ...
        if false{
            ...
            var falseCellBackground = UIView(frame: CGRect(x: 5, y: 5, width: channelListTable.frame.width - 10, height: CGFloat(falseBackgroundHeight)))
...
extension ChannelListViewController: UITableViewDelegate
{
    ...
    {
        //print("VALUE OF VISIBLE ROWS INDEX PATH\(tableView.indexPathsForVisibleRows?.index(of: indexPath))")
